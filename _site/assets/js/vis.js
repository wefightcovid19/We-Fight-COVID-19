...
var charts = {
  'states': {
    ...
    dataSelection: 'cases',
    dataSelection_y0: { 'active': 10, 'cases': 10, 'deaths': 10, 'recovered': 10 },
...
var covidData_promise = d3.csv("assets/data/county-data.csv?v=2", function (row) {
...
var render = function(chart) {
  ...
  svg.append("text")
    ...
    .text((!isSmall) ? "1.33x daily growth" : "1.33x daily");
  ...
  svg.append("text")
    ...
    .attr("text-anchor", "end")
    .text(`Data Source: SF Chronicle Updated: ${_dateUpdated} | Code Source: http://91-divoc.com/ by Wade Fagen-Ulmschneider from UIUC`)
